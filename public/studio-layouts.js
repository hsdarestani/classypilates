(()=>{
  ...
  const layouts={
    sachsen:{title:'Studio Sachsenhausen',spots:[[15,20,90],[23,20,90],[31,20,90],[39,20,90],[47,20,90],[55,20,90],[35,59,90],[69,20,90],[77,20,90],[85,20,90],[93,20,90],[78,58,0]],features:[['mirror',29,4,43,3,0,'MIRROR'],['mirror',76,90,26,3,0,'MIRROR'],['entrance',4,73,4,16,0,'ENTRANCE'],['bench',4,26,5,28,0,'SEATING'],['desk',51,71,15,12,0,'DESK']]},
    ladies:{title:'Bahnhofsviertel · 2F',spots:[[14,20,0],[14,34,0],[14,48,0],[35,34,90],[56,20,0],[56,34,0],[56,48,0],[82,20,0],[82,34,0],[82,48,0]],features:[['mirror',4,34,3,42,90,'MIRROR'],['mirror',95,34,3,42,90,'MIRROR'],['mirror',56,64,22,3,0,'MIRROR'],['entrance',12,83,11,4,0,'ENTRANCE'],['desk',23,65,14,10,0,'RECEPTION'],['column',35,62,5,5,0,''],['column',78,66,5,5,0,'']]},
    bornheim:{title:'Studio Bornheim',spots:[[20,24,0],[16,66,90],[27,66,90],[38,66,90],[49,66,90],[60,66,90],[71,66,90],[82,66,90]],features:[['mirror',4,45,3,42,90,'MIRROR'],['mirror',48,91,72,3,0,'MIRROR'],['entrance',94,67,4,17,0,'ENTRANCE'],['bench',91,53,5,20,0,'BENCH'],['desk',79,25,14,10,0,'DESK']]},
    bhf1:{title:'Bahnhofsviertel · 1F',spots:[[14,27,90],[29,27,90],[44,27,90],[59,27,90],[74,27,90],[89,27,90],[72,70,90],[88,70,90]],features:[['mirror',4,35,3,47,90,'MIRROR'],['mirror',77,4,30,3,0,'MIRROR'],['mirror',82,91,26,3,0,'MIRROR'],['entrance',5,82,4,14,0,'ENTRANCE']]},
    mid:{title:'Studio Mid',spots:[[8,42,90],[18,42,90],[28,42,90],[39,42,90],[49,42,90],[59,42,90],[70,42,90],[80,42,90],[90,42,90],[97,42,90]],features:[['mirror',17,79,23,3,0,'MIRROR'],['mirror',50,79,24,3,0,'MIRROR'],['mirror',82,79,23,3,0,'MIRROR']]},
    oval:{title:'Studio Oval',spots:[[33,27,58],[42,29,58],[51,31,58],[60,33,58],[69,35,58],[78,37,58],[87,39,58],[94,42,58],[76,68,0],[90,69,18]],features:[['mirror',56,4,54,3,0,'MIRROR'],['mirror',79,91,26,3,0,'MIRROR'],['mirror',68,58,3,22,90,'MIRROR'],['desk',10,55,13,9,0,'DESK'],['changing',36,74,39,23,0,'CHANGING ROOM'],['column',18,33,5,5,0,''],['column',26,33,5,5,0,''],['column',96,48,5,5,0,'']]}
  };
  ...
  function applyRealLayout(){
    ...
    if(topLabel)topLabel.textContent=`${layout.title} · ${capacities[id]} SPOTS`;
