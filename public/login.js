(()=>{
  ...
  const messages={invalid_credentials:'Email or password is incorrect.',inactive_user:'This account has been disabled.',password_too_short:'The password must be at least 8 characters.',name_required:'Please enter your full first and last name.',email_exists:'An account already exists for this email. Please sign in.',customer_role_missing:'Customer accounts are currently unavailable.',request_failed:'Something went wrong. Please try again.'};
