(()=>{
  ...
  const COACH_PHOTOS=[
    {match:name=>/^anna\s*k\b/.test(name),src:'/anna%20K.jpg',schedulePosition:'50% 28%'},
    {match:name=>/^sayna\b/.test(name),src:'/sayna.jpg',schedulePosition:'50% 30%'},
    {match:name=>/^luca\b/.test(name),src:'/luca.jpg',schedulePosition:'50% 26%'}
  ];
