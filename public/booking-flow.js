(()=>{
  ...
  function renderDetailsStep(){
    ...
    const switchAccount=authenticated?'<p class="booking-account-switch">You are already signed in. <button type="button" id="changeAccount">Use a different account</button></p>':first?'<p class="booking-account-switch">Already have a Classy account? <button type="button" id="useSignIn">Sign in</button></p>':'<p class="booking-account-switch">New to Classy? <button type="button" id="createAccount">Create an account</button></p>';
